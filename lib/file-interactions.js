const { readdirSync, statSync, readJSONSync, writeFileSync, writeJSONSync, readFileSync } = require('fs-extra')
...
const readPrivateKey = () => readFileSync(resolve(__dirname, './salesforce/private.key'), 'utf8')
