...
const fs = require('fs')
const { autheticateAndSendRequestToSalesforce } = require('./salesforce/sf-manager')
...
module.exports = { buildVLOVTestsforAllObjects, buildValidationRulesTestsforAllObjects }