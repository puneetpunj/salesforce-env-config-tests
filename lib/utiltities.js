...
const { buildAndWritePermissionSetTests } = require('./generate-tests-from-base-org/permission-sets')
...
const buildPermissionSetTests = async (envName, objectList) => {

    await buildAndWritePermissionSetTests(envName, objectList)
    return ('done')
}
